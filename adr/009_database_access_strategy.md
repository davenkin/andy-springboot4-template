- repository, QueryService, task are the most common places where MongoTemplate is used, all other places should not use MongoTemplate directly unless agreed by the team.
