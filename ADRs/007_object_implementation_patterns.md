...
- Aggregate roots should have a globally unique ID and this ID should be generated by the code but not by database
...
- Use factories to create Aggregate Roots makes our code more explicit as the creation of Aggregate Roots is an important
  moment in software
