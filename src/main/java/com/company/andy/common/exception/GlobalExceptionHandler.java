...
import static com.company.andy.common.exception.ErrorCode.NOT_FOUND;
import static com.company.andy.common.exception.ErrorCode.REQUEST_VALIDATION_FAILED;
import static com.company.andy.common.exception.ServiceException.accessDeniedException;
import static com.company.andy.common.exception.ServiceException.authenticationException;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<QApiErrorResponse> handleServiceException(ServiceException ex, HttpServletRequest request) {
    log.error("ServiceException occurred while access[{}]: {}", request.getRequestURI(), ex.getDetailMessage(), ex);
