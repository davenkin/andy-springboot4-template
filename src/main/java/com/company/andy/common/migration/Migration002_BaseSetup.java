...
import static com.company.andy.common.migration.MigrationUtils.createCollection;
...
public class Migration002_BaseSetup {
    ...
    public void execute(MongoTemplate mongoTemplate) {
        createCollection(PublishingDomainEvent.class, mongoTemplate);
        createCollection(ConsumingEvent.class, mongoTemplate);
        createCollection(Equipment.class, mongoTemplate);
        createCollection(MaintenanceRecord.class, mongoTemplate);
