...
public class TestingPublishingDomainEventDao extends PublishingDomainEventDao {
    private final static Set<String> processedDomainEvents = new HashSet<>();
    private final ObjectMapper objectMapper;

    public TestingPublishingDomainEventDao(MongoTemplate mongoTemplate,
    ...
    private void testForJsonSerialization(DomainEvent domainEvent) {
        ...
        if (!processedDomainEvents.contains(name)) {
            processedDomainEvents.add(name);
